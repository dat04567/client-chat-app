    ...
    <div className="modal fade" tabIndex={-1} id="videoCallingScreen" data-bs-backdrop="static" data-bs-keyboard="false">
      <div className="modal-dialog modal-dialog-centered modal-lg">
        <div className="modal-content border-0">
          <div className="tyn-chat-call tyn-chat-call-lg tyn-chat-call-video">
            ...
            <div className="tyn-chat-call-video-self">
              <img src="/images/avatar/self.jpg" alt="Self" />
              <div className="tyn-chat-call-self-info">
                <span className="meta">Your Camera is Off</span>
              </div>
            </div>
            
            <div className="tyn-chat-call-video-action">
