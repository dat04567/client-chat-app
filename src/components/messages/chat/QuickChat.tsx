...
const QuickChat = () => {
  ...
  return (
    <div className={`tyn-quick-chat ${isOpen ? 'active' : ''}`} id="tynQuickChat">
      <button className="tyn-quick-chat-toggle js-toggle-quick" onClick={toggleQuickChat}>
        ...
        <div className="tyn-quick-chat-box">
          ...
          <div className="tyn-quick-chat-reply js-scroll-to-end">
            <div className="tyn-reply tyn-reply-quick" id="tynQuickReply">
              <div className="tyn-reply-item outgoing">
                <div className="tyn-reply-group">
                  <div className="tyn-reply-bubble">
                    <div className="tyn-reply-text">Hey! How are you doing?</div>
                  </div>
                  <div className="tyn-reply-bubble">
                    <div className="tyn-reply-text">I'm heading to the office soon.</div>
                  </div>
                </div>
              </div>
              ...
              <div className="tyn-reply-item incoming">
                ...
                <div className="tyn-reply-group">
                  <div className="tyn-reply-bubble">
                    <div className="tyn-reply-text">Hi! I'm good. Thanks for asking.</div>
                  </div>
                  <div className="tyn-reply-bubble">
                    <div className="tyn-reply-text">Will you be in the office later today?</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="tyn-quick-chat-form">
            ...
            <ul className="tyn-list-inline me-n2 my-1">
              <li>
                <button 
                  className="btn btn-icon btn-white btn-sm btn-pill"
          ...
          <button 
            className="btn btn-danger btn-sm btn-icon top-0 end-0 position-absolute rounded-pill translate-middle js-toggle-quick"
