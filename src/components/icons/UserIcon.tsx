...
const UserIcon: React.FC<UserIconProps> = ({ className = 'svg-icon', width = '1em', height = '1em' }) => {
  return (
    <svg
      className={className}
      style={{ width, height, verticalAlign: 'middle', fill: 'currentColor', overflow: 'hidden', 
